        ...
        <div>
            <div className="w-full lg:px-[150px] flex flex-col justify-center items-center my-10">
                ...
                <div className='flex gap-x-4 py-5 text-center justify-center lg:flex-nowrap flex-wrap items-center'>
                    {/* Summer Section */}
                    <div className='lg:w-[450px] my-2 bg-[#0a1511]  rounded-3xl flex flex-col justify-center items-center'>
                        <Image src={img1} alt='pathway images' className='w-[100px] h-[100px] my-2' />
                        <h1 className='text-5xl font-medium text-[#e6f2ee] py-4'>Summer</h1>
                    ...
                    <div className='lg:w-[450px] my-2 bg-[#0a1511]  rounded-3xl flex flex-col justify-center items-center'>
                        ...
                        <h1 className='text-5xl font-medium text-[#e6f2ee] py-4'>Winter</h1>
                        <p className='text-[14px] font-semibold text-white py-2 px-2'>
                            20 Weeks Exclusive High Intensity program <br />
                            July - December
                        </p>
