...
const Studio = () => {
    return (
        <div className="w-full flex justify-center flex-col items-center my-12 py-12 px-4 lg:px-[150px]">
            <h1 className="text-3xl sm:text-4xl lg:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-600 py-4 text-center font-medium">
            ...
            <div className="flex flex-col lg:flex-row lg:gap-x-3 gap-y-4 flex-wrap lg:flex-nowrap justify-center items-center">
                <div className="w-full lg:w-[420px] h-[220px] bg-gradient-to-tr from-[#030706] via-[#0d251f] to-[#030706] rounded-3xl text-white flex justify-center items-end">
                ...
                <div className="flex flex-col sm:flex-row gap-4 lg:flex-nowrap">
                    <div className="bg-gradient-to-tr from-[#030706] via-[#0d251f] to-[#030706]  w-full sm:w-[210px] h-[220px] rounded-3xl px-3 flex justify-center items-end text-white">
